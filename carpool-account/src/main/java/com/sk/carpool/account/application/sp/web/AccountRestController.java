package com.sk.carpool.account.application.sp.web;
...
import com.sk.carpool.account.domain.service.AccountService;
...
public class AccountRestController implements AccountService {
	...
	@Override
	@GetMapping("/search/emailLike")
	public List<Account> findByEmailLike(@RequestParam("email") String email) {
		return accountService.findByEmailLike(email);
	}	
